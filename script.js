  ...
  const events = [
    {
      ...
      type: "homework",
      description: "During this window, you are expected to complete AAMC Full-Length Exam (FLE) #1 on your own—this is not a live meeting.\n\nTreat this like a real MCAT. Choose a quiet, neutral location (library or similar), not your usual study spot or bed. Use a computer, silence your phone, and follow the official timing: start at 8:00 AM, take only the scheduled AAMC breaks, and do not pause the exam for any other reason. Keep your desk clear of food and drinks during sections, and eat a simple, test-day-style lunch during the official lunch break (no errands, no quick Target run, no 'just grabbing coffee with a friend').\n\nThe night before, skip the cram marathon. Get 7–8 hours of sleep, avoid alcohol, and do only light review (equations, amino acids, key facts). On the morning of, eat the same kind of breakfast you plan for test day and give yourself enough time to start on time—8:00 AM means 8:00 AM, not 8:07 and not 'whenever you feel ready.'\n\nYou may not feel ready for this exam, and that’s completely fine. This score exists to help us help you—it does not go on any application and it does not define you. We use it to understand your starting point, identify strengths and weaknesses, and build a realistic study plan. Please do not pause outside of breaks, look up answers, or inflate your score in any way. Honesty here is a superpower: accurate data in means a better plan out.\n\nWhen you’re done, report your scores under the My Scores section of the student portal so we can track your progress over time."
    },
    {
